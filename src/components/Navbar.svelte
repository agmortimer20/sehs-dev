      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li>
              <a class="dropdown-item" href="/comp-sci/javascript/"
                >JavaScript Fundamentals</a
              >
            </li>
            <li>
              <a class="dropdown-item" href="/comp-sci/python/"
                >Python Fundamentals</a
              >
            </li>
            <li>
              <a class="dropdown-item" href="/comp-sci/code-challenges/"
                >Code Challenges</a
              >
            </li>
          </ul>
...
<style>
  ...
  .cursor {
    animation: cursor 1s none infinite;
  }
</style>
